...
class Material:
    def __init__(self, name: str, diffuse: glm.vec3, specular: glm.vec3, shininess: float, reflection_intensity: float, emissive_color: glm.vec3, power: int, attenuation: list):
        self.name = name
